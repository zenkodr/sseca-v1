...
const Navbar = () => {
  ...
  return (
    <div className='fixed z-[600] h-[80px] w-[100vw] txt-base items-center justify-center bg-sseca-blackPearl/70 px-5 shadow-md shadow-sseca-zombie max-sm:hidden'>
            ...
            <section className='flex w-[100vw] items-center justify-evenly rounded-xl border border-sseca-zombie bg-sseca-blackPearl  py-2 text-sseca-zombie shadow-md shadow-sseca-ebony'>
              <HoverCard openDelay={200}>
                <HoverCardTrigger asChild>
                  <a href='/' className='hoverCard-link'>Home</a>
                </HoverCardTrigger>
